  ...
  <div class="seller">
    <div class="seller-content">
      ...
      <div class="seller">
        ...
        <ul>
          <li class="seller-item" v-for="seller in seller.sellers">{{seller}}</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  export default {
    ...
    data() {
      return {
        seller: this.info,
        favorite: (() => {
          return loadFromlLocal(this.info.id, 'favorite', false);
        })()
      };
    },
    computed: {
      ...
      if (!this.picScroll) {
        if (this.info.pics) {
          this.$nextTick(() => {
            let picWidth = 120;
            let margin = 6;
            let width = (picWidth + margin) * this.info.pics.length - margin;
    ...
    methods: {
      ...
      toggleFavorite(event) {
        ...
        savaToLocal(this.info.id, 'favorite', this.favorite);
      }
    }
  };
</script>
